...
namespace OneButtonApi
{
    public class Common
    {
        public const string API_ID = "c298268b";
        public const string API_KEY = "600736690c93646b89e3230480978629";
        public const string API_URI = "http://1button.info/";
        public const string CAMBA_AUTH_KEY = "X-CAMBA-AUTH";
        public const string DOWNLOAD_URL = "http://1button.info/downloads/";
        ...
        public static class Utility
        {
            public static string GetTimezone(string tzId)
            {
                ...
                try
                {
                    ...
                    //XElement xelement = XElement.Load(HttpContext.Current.Server.MapPath("~/bin/tzone.xml"));
