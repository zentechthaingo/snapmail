var Index = function () {
    ...
    var handleLoginSection = function() {
        ...
        //localStorage.setItem("oAuthToken", "907ff44076c4e267509b8c4d1409294a");
        //localStorage.setItem("tokenExpiry", "315568999");
        //localStorage.setItem("appUserId", "shakeelanjum");
        //localStorage.setItem("AppUsername", "Shakeel Anjum");
        /* --------- END --------- */
            ...
            if (stringHash != "") {
                ...
                if (hasToken != "" && hasToken != null) {
                    ...
                    $.ajax({
                        ...
                        data: { token_endpoint: "https://auth.evercam.io/oauth2/tokeninfo?access_token=" + hasToken },
                        dataType: 'json',
                        ...
                        success: function(res) {
                            if (res.userid != "null" && res.userid != '') {
                                ...
                                localStorage.setItem("AppUsername", userId);
    ...
    $(".formButtonOk").live("click", function () {
        ...
        var o = {
            ...
            "user_name": localStorage.getItem("AppUsername"),
            "cameras": cameraIds,
    ...
    var getSnapmails = function (refresh, key) {
        ...
        $("#displayUsername").html(localStorage.getItem("AppUsername"));
        ...
        else
        {
            ...
            $.ajax({
                type: 'GET',
                url: appApiUrl + "/users/" + localStorage.getItem("appUserId"),
                dataType: 'json',
                ContentType: 'application/json; charset=utf-8',
                success: function (snapMail) {
    ...
    var getCameras = function(reload) {
        $.ajax({
            ...
            data: { user_id: localStorage.getItem("appUserId"), include_shared: true, thumbnail: false },
            beforeSend: function(xhrObj) {
    ...
    var getUsersInfo = function () {
        $.ajax({
            ...
            url: EvercamApi + "/users/" + localStorage.getItem("appUserId") + ".json",
            beforeSend: function (xhrObj) {
                xhrObj.setRequestHeader("Authorization", localStorage.getItem("oAuthTokenType") + " " + localStorage.getItem("oAuthToken"));
            },
            contentType: "application/json; charset=utf-8",
            ...
            success: function (res) {
                ...
                if (res.users[0].firstname == "" && res.users[0].lastname == "")
                    return;
                localStorage.setItem("AppUsername", res.users[0].firstname + " " + res.users[0].lastname);
